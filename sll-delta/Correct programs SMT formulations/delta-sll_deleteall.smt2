...
;@precondition: list(x) && mkeys(x).arb == constval
(assert (and 
(ls x nil)
...
;negate@x = temp && list(x) && mkeys(x).kk = mkeys(temp).kk
...
;@x = temp && list(x) && mkeys(x).kk = mkeys(temp).kk
;;&& mkeys(x).arb == constval
(assert (and 
(= x temp)
(ls x nil)
...
;@ls(x, temp) && list(x) && mkeys(x).kk = mkeys(temp).kk && temp.key =/= kk
;;&& mkeys(x).arb == constval
(assert (and 
(ls x temp)
(ls x nil)
...
;negate@ls(x, temp) && list(x) && mkeys(x).kk = mkeys(temp).kk && temp.key =/= kk
;;&& mkeys(x).arb == constval
(assert (not (and 
(ls2 x temp)
(ls2 x nil)
