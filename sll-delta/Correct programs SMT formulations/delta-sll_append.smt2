...
;@pre: list(x) && list(y) && hlist(x) \intersect hlist(y) = \empty
(assert (and (ls x nil) 
(and (ls y nil) 
...
;negate@list(x2) && mkeys(x2) = mkeys(x) \union mkeys(y)
(assert (not
(and (ls x2 nil)
(and (= (mkeys x2 nil) (mult-union (mkeys x nil) (mkeys y nil)))
(and (= (hls x2 nil) (union (hls x nil) (hls y nil)))
)))))
(check-sat)
(get-model)
(pop)
...
(assert (and (ls x nil) 
(and (ls y nil) 
(and (= (intersect (hls x nil) (hls y nil)) empLoc)
(and (= oldhls (union (hls x nil) (hls y nil)))
(= oldmkeys (mult-union (mkeys x nil) (mkeys y nil)))
)))))
(assert (base nil))
(assert (t_propagate_for_vars nil))

;negate@temp =/= nil && ls (x, temp) && list(y) && hlist(x) \intersect hlist(y) = \empty
(assert (not
(and (not (= temp nil))
(and (ls x temp)
(and (ls y nil)
...
;@temp =/= nil && ls (x, temp) && list(y) && hlist(x) \intersect hlist(y) = \empty
(assert
(and (not (= temp nil))
(and (ls x temp)
(and (ls y nil)
...
(assert (closed-sys (select n temp)))
;;return x
;@temp.next == nil && temp =/= nil && ls (x, temp) && list(y) && hlist(x) \intersect hlist(y) = \empty
(assert
(and (not (= temp nil))
(and (= (select n temp) nil)
(and (ls x temp)
(and (ls y nil)
(and (= (intersect (hls x nil) (hls y nil)) empLoc)
(and (= oldhls (union (hls x nil) (hls y nil)))
...
;negate@list(x) && mkeys2(x) = mkeys(x) \union mkeys(y)
(assert (not
(and (ls2 x nil)
(and (= (mkeys2 x nil) oldmkeys)
(= (hls2 x nil) oldhls)
))))
(assert (base2 nil) )
